  ...
  const transformApiData = (apiOrder) => {
    ...
    return {
      ...
      packageInfo: {
        ...
        imageUrl: apiOrder.package.imageUrl || '',
        location: apiOrder.package.location || null
      },
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-8 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                ...
                {trackingResult.packageInfo.imageUrl && (
              ...
              {trackingResult.packageInfo.location?.lat && trackingResult.packageInfo.location?.lng && (
                <div className="mt-4">
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mb-3">
                    Current package location based on the latest coordinates.
                  </p>
                  <div className="relative h-64 sm:h-72 w-full rounded-lg overflow-hidden border border-yellow-200 bg-gray-200">
                    <iframe
                      ...
                      src={`https://www.openstreetmap.org/export/embed.html?bbox=${trackingResult.packageInfo.location.lng - 0.03},${trackingResult.packageInfo.location.lat - 0.02},${trackingResult.packageInfo.location.lng + 0.03},${trackingResult.packageInfo.location.lat + 0.02}&layer=mapnik&marker=${trackingResult.packageInfo.location.lat},${trackingResult.packageInfo.location.lng}`}
